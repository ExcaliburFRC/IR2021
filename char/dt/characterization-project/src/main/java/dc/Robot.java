...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 10.25;
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(13, Sides.LEFT, false);

    CANSparkMax leftFollowerID14 = setupCANSparkMax(14, Sides.FOLLOWER, false);
    leftFollowerID14.follow(leftMotor, false);
        
    

    CANSparkMax rightMotor = setupCANSparkMax(11, Sides.RIGHT, false);
    CANSparkMax rightFollowerID12 = setupCANSparkMax(12, Sides.FOLLOWER, false);
    rightFollowerID12.follow(rightMotor, false);
