...
class Robot : public frc::TimedRobot {
 ...
 private:
  void AddMotorController(int port, std::string controller, bool inverted);
  void SetMotorControllers(units::volt_t power);
  ...
  std::unique_ptr<rev::CANEncoder> m_canencoder;
